package com.oneflow.comm.constant;

/**
 * 系统常量
 * 如果使用class类需要显式声明每个变量为public static final
 *      如：public static final String UTF_8 = "UTF-8";
 * 如果使用接口则不需要声明为public static final，因为接口默认是public static final
 */
public interface OneflowConstant {
    /**
     * 编码
     */
    String UTF_8 = "UTF-8";
